...
if (isset($_POST['Terima'])) {
    ...
    //buatwa
    $_SESSION['kodebookcust'] = $kodebook;
    $_SESSION['namacust'] = $nama;
    $_SESSION['nowacust'] = $nowa;
    $_SESSION['tglcust'] = $tgl;
    $_SESSION['wktcust'] = $wkt;
    $_SESSION['treatmentcust'] = $kdtreatment;


    $sqldel = "UPDATE tbooking SET konfirmasi = 'Terima' WHERE kdbook = '$kdbook'";
    $qdel = mysqli_query($db, $sqldel);
    if ($qdel) {
        $sukses = "Berhasil Menerima Booking";
        header("Location: controller/sendwa.php");
    } else {
        $error = "Gagal Menerima Booking";
    }
}
...
if (isset($_POST['Update'])) {
    ...
    if ($qup) {
        $sukses = "Berhasil Mengupdate data Booking";
    } else {
        $error = "Gagal Update data Booking";
    }
}
...
<br>
<h1 class="text-center">Booking Masuk</h1>
<br>
<div class="card mb-4">
    <div class="card-header">
        <i class="fas fa-table me-1"></i>
        Data Table Konfirmasi Booking
    </div>
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                ...
                                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#konfirmasi<?= $urut ?>"><i class="fas fa-square-check"></i></button>
                            </div>
                        </td>
                    </tr>
                        ...
                        <div class="modal-dialog modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Apakah anda ingin menghapus Booking ini?</h5>
 ...
 Treatment  : <?= $kdtreatment ?>
                    ...
                    <div class="modal" id="konfirmasi<?= $urut ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Terima Booking ini ?</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <form method="post" action="">
                                    <div class="modal-body">
 ...
 Treatment  : <?= $kdtreatment ?>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-primary text-bg-success" name="Terima"><i class="fas fa-check"></i> Terima</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="modal fade" id="editbook<?= $urut ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Edit Booking Masuk</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <form method="post" action="">
                                    <div class="modal-body">
